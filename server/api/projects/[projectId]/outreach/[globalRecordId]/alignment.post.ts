...
export default defineEventHandler(async (event) => {
  ...
  // Obchodní tým může spustit analýzu jen pro partnery, ke kterým je přiřazen.
  // Vedení obchodu (project.interactions.edit_all) a Admin mají právo zastoupit kohokoli.
