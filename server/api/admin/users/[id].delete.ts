...
export default defineEventHandler(async (event) => {
    ...
    select: {
      _count: {
        select: {
          ...
          noteAssignments: true,
          fulfillmentAssignments: true,
  ...
  const blockers: Record<string, string> = {
    ...
    emailsCreated: 'e-maily',
    notesCreated: 'poznámky',
    emailAssignments: 'přiřazení e-mailů',
    noteAssignments: 'přiřazení poznámek',
    fulfillmentAssignments: 'přiřazení plnění',
